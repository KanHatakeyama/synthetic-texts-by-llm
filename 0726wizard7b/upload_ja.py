...
repo_id = "kanhatakeyama/logical-wizardlm-7b-ja-0805"
jsonl_dir = "0802out_trans/"
            ...
            for obj in reader:
                if writer is None or current_size >= max_size:
                    ...
                    output_file = os.path.join(
                        output_dir, f"split_{timestamp}_{file_index}.jsonl")
...
# 処理済みファイルのリストを保存するJSONファイルのパス
processed_file_path = f"{jsonl_dir}/upload/processed_files.json"
